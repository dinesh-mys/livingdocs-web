    ...
    "livingdocs": {
      ...
      <footer className="border-t border-white/10 px-6 py-8 max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-4 text-white/40 text-sm">
          <span>© 2026 Novaders LLP · MIT License</span>
          <span>·</span>
          <a href="https://dinesh-mys.github.io/livingdocs-web/privacy.html" target="_blank" className="hover:text-white transition">Privacy Policy</a>
          <span>·</span>
          <a href="https://dinesh-mys.github.io/livingdocs-web/terms.html" target="_blank" className="hover:text-white transition">Terms of Service</a>
        </div>
